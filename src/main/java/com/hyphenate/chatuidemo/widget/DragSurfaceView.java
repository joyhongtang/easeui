...
/**
  * @Description:    可拖动的SurfaceView
  * @Author:         TJ
  * @CreateDate:     2020/3/27 18:27
  * @UpdateUser:     更新者：
  * @UpdateDate:     2020/3/27 18:27
  * @UpdateRemark:   更新说明：
  * @Version:        1.0
 */
public class DragSurfaceView extends EMCallSurfaceView implements View.OnTouchListener {
     ...
     * @Description:    点击事件监听
     */
    private DragSurfaceViewClickLis dragSurfaceViewClickLis;
    private final String TAG = DragSurfaceView.class.getSimpleName();
    /**
     * 线程延迟
     */
    private static final int MAX_INTERVAL_FOR_DRAW = 100;
    ...
    public boolean onTouch(View v, MotionEvent event) {
        ...
        invalidate();
        postDelayed(mTimerForLayoutControl, MAX_INTERVAL_FOR_DRAW);
        return true;
    }
...
//  v.layout(left, top, right, bottom);
    ...
    public void onSingleClick() {
        ...
        if(null != dragSurfaceViewClickLis){
            dragSurfaceViewClickLis.onDragSurfaceClick(this);
        }
    }

    public void onDoubleClick() {
    }
    Runnable mTimerForLayoutControl = new Runnable() {
        @Override
        public void run() {
            if (mIsWaitDraw) {
                mIsWaitDraw = false;
    ...
    public void setDragSurfaceViewClickLis(DragSurfaceViewClickLis dragSurfaceViewClickLis) {
        this.dragSurfaceViewClickLis = dragSurfaceViewClickLis;
    }
    public interface DragSurfaceViewClickLis{
