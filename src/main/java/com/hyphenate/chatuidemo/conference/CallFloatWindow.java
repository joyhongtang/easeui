...
public class CallFloatWindow {
    ...
    public void updateConferenceTime(String time) {
        try {
            ...
            TextView timeTxt = floatView.findViewById(R.id.time);
    ...
    public void update(EMConferenceStream stream) {
        ...
        BaseActivity baseActivity = ActivityPageManager.getInstance().findActivity("ConferenceActivity");
        if (!(baseActivity instanceof ConferenceActivity)) {
            return;
        }
        if (baseActivity.getIntent().getIntExtra(KEY_CALL_TYPE, -1) == 1) { // 视频未开启
        ...
        if (baseActivity.getIntent().getIntExtra(KEY_CALL_TYPE, -1) == 1) {
            avatarView.setImageResource(R.drawable.em_call_mic_on1);
        } else if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            if(null != surfaceView) {
                surfaceView.setOutlineProvider(new TextureVideoViewOutlineProvider(22));
...
//                        if (left < splitLine) {
//                            // 滑动到最右边
//                            if(floatView.findViewById(R.id.layout_call_voice).getVisibility() == View.VISIBLE)
//                            floatView.findViewById(R.id.layout_call_voice).setBackgroundResource(R.drawable.ease_chat_voice_float);
//                            Resources resources = Constant.application.getResources();
//                            Drawable drawable = resources.getDrawable(R.drawable.ease_chat_voice_float);
//                            floatView.findViewById(R.id.layout_call_video).setBackground(drawable);
//                            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
//                                surfaceView.setOutlineProvider(new TextureVideoViewOutlineProvider(20));
//                                surfaceView.setClipToOutline(true);
//                            }
//                        } else {
//                            // 滑动到最左边
//                            if(floatView.findViewById(R.id.layout_call_voice).getVisibility() == View.VISIBLE)
//                            floatView.findViewById(R.id.layout_call_voice).setBackgroundResource(R.drawable.ease_chat_voice_float_left);
//                            Resources resources = Constant.application.getResources();
//                            Drawable drawable = resources.getDrawable(R.drawable.ease_chat_voice_float_left);
//                            floatView.findViewById(R.id.layout_call_video).setBackground(drawable);
//                            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
//                                surfaceView.setOutlineProvider(new TextureVideoViewOutlineProvider(20));
//                                surfaceView.setClipToOutline(true);
