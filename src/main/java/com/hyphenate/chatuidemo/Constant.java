...
import com.hyphenate.chatuidemo.conference.UserActivityLifecycleCallbacks;
import com.hyphenate.easeui.EaseConstant;

public class Constant extends EaseConstant{
	public static String GENERATE_SECRET;
	public static int ID;
	public static String token;
	public static boolean  isDualScreen = false;
	public static boolean login_im_success = false;
	public static String SNNUMBER;
	public static Application application;
	public  static UserActivityLifecycleCallbacks userActivityLifecycleCallbacks;
